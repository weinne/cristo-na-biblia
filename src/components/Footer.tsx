      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="space-y-4">
            <h3 className="text-xl font-bold text-primary">Cristo na Bíblia</h3>
          ...
          <div className="space-y-4">
            <h4 className="text-sm font-semibold text-primary">Links Rápidos</h4>
          ...
          <div className="space-y-4">
            <h4 className="text-sm font-semibold text-primary">Sobre o Projeto</h4>
            <p className="text-sm text-muted-foreground">
