...
const ExploreMoreSection = () => {
  return (
    <motion.div 
      ...
      className="mt-16 bg-muted dark:bg-gray-800 p-6 rounded-lg text-center"
    >
      <h3 className="text-xl font-bold text-primary dark:text-gray-200 mb-4">Pronto para explorar os livros da Bíblia?</h3>
