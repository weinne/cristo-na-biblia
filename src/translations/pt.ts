export const pt = {
  ...
  'seeing-christ': 'Cristo Visto em Toda a Escritura',
  'greidanus-proposed': 'Sidney Greidanus propôs sete maneiras confiáveis de ver Cristo nas Escrituras. Essas categorias fornecem uma estrutura para entender as várias formas pelas quais Jesus é revelado em toda a Bíblia.',
  'solid-methods': 'Métodos Hermenêuticos Sólidos',
  'categories-represent': 'Cada categoria representa uma abordagem fundamentada em princípios hermenêuticos sólidos para conectar o texto bíblico a Cristo sem cair em alegorização ou eisegese.',
  ...
  'greidanus-bio': 'Sidney Greidanus é um erudito respeitado e professor emérito de pregação no Seminário Teológico Calvin. Seu trabalho sobre pregação cristocêntrica tem sido influente em ajudar pastores e professores a conectar toda a Bíblia a Cristo de maneiras responsáveis.',
  ...
  'different-ways': 'Diferentes maneiras pelas quais Cristo é revelado nas Escrituras',
  ...
  'discover-how': 'Descubra como Cristo é revelado em cada livro da Bíblia usando essas categorias.',
  ...
  'genesis-redemptive-historical': 'Gênesis inicia a história redentora que culmina em Cristo, desde a promessa da semente da mulher até as bênçãos a todas as nações através de Abraão.',
  ...
  'exodus-redemptive-historical': 'O Êxodo do Egito representa um marco crucial na história redentora, prefigurando a grande libertação que viria através de Cristo.',
